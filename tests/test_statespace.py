...
from pymc_statespace.core.statespace import FILTER_FACTORY, PyMCStateSpace
...
def test_unpack_matrices():
    ...
    mod = PyMCStateSpace(data=data[..., 0], k_states=m, k_posdef=r, filter_type="standard")
...
def test_param_names_raises_on_base_class():
    mod = PyMCStateSpace(data=nile, k_states=5, k_posdef=1, filter_type="standard")
...
def ss_mod():
    class StateSpace(PyMCStateSpace):
        ...
        def update(self, theta):
            self.ssm["transition", 0, 0] = theta[0]
